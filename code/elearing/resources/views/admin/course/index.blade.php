    ...
    <table class="table table-striped">
      ...
      <tbody class="table-border-bottom-0">
        ...
        <tr>
          ...
          <td>
            <img src="{{asset($item->image)}}" alt="image" height="125" class="me-4 mb-sm-0 mb-2">
          </td>
          <td>
            @if ($item->status == '0')
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col mb-3">
            ...
            <input type="file" name="image" required id="nameWithTitle" class="form-control" placeholder="image">
          </div>
        </div>
        <div class="mb-3">
  ...
  <form action="{{ route('updateCourse') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col mb-3">
            <label for="nameWithTitle" class="form-label">Image(optional)</label>
            <input type="file" name="image"  id="nameWithTitle" class="form-control" placeholder="image">
          </div>
        </div>
        <div class="mb-3">
          <label for="exampleFormControlSelect1" class="form-label">Status</label>
