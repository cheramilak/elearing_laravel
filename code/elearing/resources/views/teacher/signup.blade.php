        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form method="POST" action="{{ route('storInstructor') }}" class="pt-3" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="file" required name="file" class="form-control form-control-lg @error('file') is-invalid @enderror" placeholder="your cv">
                    @error('file')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
